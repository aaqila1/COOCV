...
while (cap.isOpened()):
    ...
    try:
        ...
        print('EOF')
        print('Customers Exit:', cnt_up)
        print('Customers Enter:', cnt_down)
        break
    ...
    str_up = 'Customers Exit: ' + str(cnt_up)
    str_down = 'Customers Enter: ' + str(cnt_down)
